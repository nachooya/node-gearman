...
function Gearman (jobServers, debug){
...
Gearman.prototype.connect = function(){
    ...
    for (var i = 0; i < this.jobServers.length; i++) {
        (function(_this, i) {
            ...
            if(_this.debug) {
                console.log("connecting to server "+i+" -> "+_this.jobServers[i].host+":"+_this.jobServers[i].port);
            }
            ...
            _this.sockets[i].on("connect", (function(){
                ...
                if(_this.debug){
                    console.log("connected to server "+i+"-> "+_this.jobServers[i].host+":"+_this.jobServers[i].port);
                }
                _this.emit("connect");
...
Gearman.prototype.closedSocket = function (serverNum) {
    ...
    if (this.debug) {
        console.log ("socket closed: serverNum: "+serverNum);
    }
...
Gearman.prototype.errorHandler = function (serverNum, err){
    ...
    if (this.debug) {
        console.log ("socket errorHandler: "+err);
    }
